...
string projectAddress = "/home/farhad/Codes/Cpp/evpRate/version2/";
...
// The Physical domain is divided into 3 sub-domains: 1.surface of liquid (surf) 2.film layer (film) 3.surrounding (surr)
...
void computeInlets(int k)
{
    ...
    double qMax = 50;
    double fireTemperature = 298; // Kelvin
    surr.T = fireTemperature;
    q = qMax;
...
string variableNames = "NIST-fixedQ-fixedT"; // to_string(int(q))+  "kw-" +to_string(int(surr.T)) + "K";
...
void createFile()
{
    string evpRateAddress = projectAddress + "results/evpRate/" + variableNames;
    string temperatureAddress = projectAddress + "results/temperature/" + variableNames;
    string nusseltAddress = projectAddress + "results/nusselt/" + variableNames;
    string spaldingAddress = projectAddress + "results/spalding/" + variableNames;
    string massAddress = projectAddress + "results/mass/" + variableNames;
    string depthAddress = projectAddress + "results/depth/" + variableNames;
    string grashofAddress = projectAddress + "results/grashof/" + variableNames;
    string filmDensityAddress = projectAddress + "results/filmDensity/" + variableNames;
    // string rayleighAddress = projectAddress + "results/Rayleigh";
    // string prandtlAddress = projectAddress + "results/Prandtl";
    // string propertyAddress = projectAddress + "results/property";
    // string logAddress = projectAddress + "results/Log";
...
int main()
{
    algorithm(); // This function contains the algorithm of code
